...
def get_text_messages(message):
    ...
    if message.text == 'Поздороваться':
        ...
        bot.send_message(message.from_user.id, """Математика - 9:00-10:30
                ИМК - 10:40-12:10
                Литература - 12:10-14:15
                ЭТМ - 14:25-15:55""")
        bot.send_message(message.from_user.id, """Четверг: """)
        bot.send_message(message.from_user.id, """Оркестровый класс - 10:40-13:55
        ОБЖ - 14:25-15:55""")
        bot.send_message(message.from_user.id, """Пятница: """)
        bot.send_message(message.from_user.id, """Музыкальная литература - 14:45-15:55
                Сольфеджио- 16:05-17:35""")
        bot.send_message(message.from_user.id, """Суббота: """)
        bot.send_message(message.from_user.id, """Русский язык - 12:45-14:15
        ...
        bot.send_message(message.from_user.id, """Пятница: """)
        bot.send_message(message.from_user.id, """ОМузыкальная литература - 14:45-15:55
                Сольфеджио- 16:05-17:35""")
